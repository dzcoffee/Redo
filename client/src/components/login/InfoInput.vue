<template>
    <v-col class="pa-0 my-2 d-flex align-center justify-space-between">
        ...
        <input :type="isSecure ? 'password' : 'text'" class="info-input px-1" :style="{'border-color': validColor}" :placeholder="placeholder" :value="inputValue" @input="changeInput">
...
const isValid = computed(() => {return valid && (inputValue.value.length <= 10)});
